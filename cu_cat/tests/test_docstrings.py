...
DOCSTRING_TEMP_IGNORE_SET = {
    "cu_cat._datetime_encoder.DatetimeEncoder.get_feature_names",
    "cu_cat._datetime_encoder.DatetimeEncoder.get_feature_names_out",
    "cu_cat._gap_encoder.GapEncoder.get_feature_names",
    "cu_cat._gap_encoder.GapEncoder.get_feature_names_out",
    "cu_cat._gap_encoder.GapEncoder.partial_fit",
    "cu_cat._gap_encoder.GapEncoder.score",
    "cu_cat._gap_encoder.GapEncoder.transform",
    "cu_cat._minhash_encoder.MinHashEncoder",
    "cu_cat._minhash_encoder.MinHashEncoder.fit",
    "cu_cat._similarity_encoder.SimilarityEncoder",
    "cu_cat._similarity_encoder.SimilarityEncoder.fit_transform",
    "cu_cat._table_vectorizer.TableVectorizer.fit_transform",
    "cu_cat._table_vectorizer.TableVectorizer.get_feature_names",
    "cu_cat._table_vectorizer.TableVectorizer.get_feature_names_out",
    "cu_cat._table_vectorizer.TableVectorizer.transform",
    # TODO: remove when SuperVectorizer name is removed
    "cu_cat._table_vectorizer.SuperVectorizer",
    "cu_cat._table_vectorizer.SuperVectorizer.fit_transform",
    "cu_cat._table_vectorizer.SuperVectorizer.get_feature_names",
    "cu_cat._table_vectorizer.SuperVectorizer.get_feature_names_out",
    "cu_cat._table_vectorizer.SuperVectorizer.transform",
    "cu_cat._target_encoder.TargetEncoder",
    "cu_cat._fuzzy_join.fuzzy_join",
