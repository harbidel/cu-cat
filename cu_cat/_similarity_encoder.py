...
class SimilarityEncoder(OneHotEncoder):
    ...
    ----------
    similarity : None
        Deprecated in cu_cat 0.3, will be removed in 0.5.
    ...
    def __init__(
        ...
        if similarity is not None:
            warnings.warn(
                'The "similarity" argument is deprecated since cu_cat 0.3, '
    ...
    def fit(self, X, y=None) -> "SimilarityEncoder":
        ...
        :class:`~cu_cat.SimilarityEncoder`
            The fitted :class:`~cu_cat.SimilarityEncoder` instance (self).
        """
    ...
    def _ngram_similarity_fast(
        ...
        :func:`~cu_cat.SimilarityEncoder.transform` uses the count vectors
