...
class SimilarityEncoder(OneHotEncoder):
    ...
    def fit(self, X, y=None) -> "SimilarityEncoder":
        ...
        :class:`~cuCat.SimilarityEncoder`
            The fitted :class:`~cuCat.SimilarityEncoder` instance (self).
        """
    ...
    def _ngram_similarity_fast(
        ...
        :func:`~cuCat.SimilarityEncoder.transform` uses the count vectors
        ...
        :attr:`~cuCat.SimilarityEncoder.vocabulary_count_matrices`,
