...
DOCSTRING_TEMP_IGNORE_SET = {
    ...
    "cuCat._table_vectorizer.TableVectorizer.fit_transform",
    "cuCat._table_vectorizer.TableVectorizer.get_feature_names",
    "cuCat._table_vectorizer.TableVectorizer.get_feature_names_out",
    "cuCat._table_vectorizer.TableVectorizer.transform",
    # TODO: remove when SuperVectorizer name is removed
    "cuCat._table_vectorizer.SuperVectorizer",
    "cuCat._table_vectorizer.SuperVectorizer.fit_transform",
    "cuCat._table_vectorizer.SuperVectorizer.get_feature_names",
    "cuCat._table_vectorizer.SuperVectorizer.get_feature_names_out",
    "cuCat._table_vectorizer.SuperVectorizer.transform",
    "cuCat._target_encoder.TargetEncoder",
    "cuCat._fuzzy_join.fuzzy_join",
    # The following are not documented in cuCat (and thus are out of scope)
    # They are usually inherited from other libraries.
    "cuCat._table_vectorizer.TableVectorizer.fit",
    "cuCat._table_vectorizer.TableVectorizer.set_params",
    "cuCat._table_vectorizer.TableVectorizer.named_transformers_",
    "cuCat._table_vectorizer.SuperVectorizer.fit",
    "cuCat._table_vectorizer.SuperVectorizer.set_params",
    "cuCat._table_vectorizer.SuperVectorizer.named_transformers_",
    # The following are internal functions
    "cuCat._check_dependencies.check_dependencies",
}
